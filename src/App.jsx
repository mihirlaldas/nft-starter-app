...
const CONTRACT_ADDRESS = "0x5230e42E8f047ECc36E56C437935E8daC3D4B4d2";
...
const App = () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          ...
          setOpenSeaUrl(`https://testnets.opensea.io/assets/${CONTRACT_ADDRESS}/${tokenId.toNumber()}`)
  ...
  return (
    ...
    : (<>
      ...
      {openSeaUrl && (
        <a href={openSeaUrl} target="_blank" className="cta-button connect-wallet-button">
        see your new NFT
      </a>
      )}
    </>)
